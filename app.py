...
from presentation.api.profile_routes import profile_routes, init_routes as init_profile_routes
...
profile_service = TeacherProfileService(teacher_repository)
...
init_profile_routes(profile_service)
